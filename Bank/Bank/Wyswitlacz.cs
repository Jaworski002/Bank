...
namespace Bank
{
    public static class Wyswitlacz
    {
        ...
        public static void PokazEkranKlientow()
        {
            ...
            Console.WriteLine("1 | Jan Nowak | 001 | " + K1 + " zł");
            var K2 = Dane.Klient2.ToString();
            Console.WriteLine("2 | Agnieszka Kowalska | 002 | " + K2 + " zł");
            var K3 = Dane.Klient3.ToString();
            Console.WriteLine("3 | Robert Lewandowski | 003 | " + K3 + " zł");
            var K4 = Dane.Klient4.ToString();
            Console.WriteLine("4 | Zofia Plucińska | 004 | " + K4 + " zł");
            var K5 = Dane.Klient5.ToString();
            Console.WriteLine("5 | Grzegorz Braun | 005 | " + K5 + " zł");
        }
        public static void Klient1Info()
        {
            ...
            Console.WriteLine("SALDO: " + Dane.Klient1.ToString() + " zł");
        ...
        public static void Klient2Info()
        {
            ...
            Console.WriteLine("SALDO: " + Dane.Klient2.ToString() + " zł");
            Console.WriteLine("WPISZ NUMER KONTA NA KTÓRY CHCESZ WYKONAĆ PRZELEW:");
        }
        public static void Klient3Info()
        {
            ...
            Console.WriteLine("SALDO: " + Dane.Klient3.ToString() + " zł");
            Console.WriteLine("WPISZ NUMER KONTA NA KTÓRY CHCESZ WYKONAĆ PRZELEW:");
        }
        public static void Klient4Info()
        {
            ...
            Console.WriteLine("SALDO: " + Dane.Klient4.ToString() + " zł");
            Console.WriteLine("WPISZ NUMER KONTA NA KTÓRY CHCESZ WYKONAĆ PRZELEW:");
        }
        public static void Klient5Info()
        {
            ...
            Console.WriteLine("SALDO: " + Dane.Klient5.ToString() + " zł");
            Console.WriteLine("WPISZ NUMER KONTA NA KTÓRY CHCESZ WYKONAĆ PRZELEW:");
        }
